...
fn error_code_computation_821043386() {
  let tmp1 = [
    29, 10, 145, 40, 0, 90, 126, 137, 221, 186, 137, 39, 208, 250, 199, 176, 202, 124, 200, 85, 63,
    254,
  ];
  let tmp2 = [
  ...
  assert_eq!(
    div[255 - 29..],
    ([
      0, 85, 37, 253, 234, 217, 13, 16, 62, 107, 80, 72, 22, 66, 240, 139, 57, 109, 195, 68, 121,
      32, 206, 196, 117, 252, 175, 189, 167
    ])
  )
}
...
fn error_code_computation_struct_31_0() {
  ...
  assert_eq!(
    div[255 - 26..],
    ([
      68, 150, 68, 205, 197, 78, 104, 100, 177, 0, 185, 7, 178, 106, 110, 170, 101, 222, 45, 74,
      31, 75, 3, 126, 216, 208
    ])
  )
}
...
fn error_code_computation_struct_31_1() {
  ...
  assert_eq!(
    div[255 - 26..],
    ([
      246, 74, 169, 24, 210, 247, 165, 59, 102, 186, 144, 234, 202, 247, 84, 191, 166, 28, 140,
      190, 219, 81, 72, 34, 159, 0
    ])
  )
}
