...
fn version_format_l_mask6() {
  ...
  const EXPECTED: [bool; 15] = [
    true, true, false, true, true, false, false, false, true, false, false, false, false, false,
    true,
  ];
...
fn version_format_m_mask0() {
  ...
  const EXPECTED: [bool; 15] = [
    true, false, true, false, true, false, false, false, false, false, true, false, false, true,
    false,
  ];
...
fn version_format_m_mask1() {
  ...
  const EXPECTED: [bool; 15] = [
    true, false, true, false, false, false, true, false, false, true, false, false, true, false,
    true,
  ];
...
fn version_format_m_mask7() {
  ...
  const EXPECTED: [bool; 15] = [
    true, false, false, true, false, true, false, true, false, true, false, false, false, false,
    false,
  ];
...
fn version_format_q_mask1() {
  ...
  const EXPECTED: [bool; 15] = [
    false, true, true, false, false, false, false, false, true, true, false, true, false, false,
    false,
  ];
...
fn version_format_q_mask5() {
  ...
  const EXPECTED: [bool; 15] = [
    false, true, false, false, false, false, true, true, false, false, false, false, false, true,
    true,
  ];
...
fn version_format_h_mask5() {
  ...
  const EXPECTED: [bool; 15] = [
    false, false, false, false, false, true, false, false, true, false, true, false, true, false,
    true,
  ];
...
fn version_format_h_mask7() {
  ...
  const EXPECTED: [bool; 15] = [
    false, false, false, true, false, false, false, false, false, true, true, true, false, true,
    true,
  ];
...
fn version_format_l_mask0_version23() {
  ...
  let mut expected2: [bool; 18] = [
    false, true, false, true, true, true, false, true, true, true, true, true, true, false, true,
    true, false, false,
  ];
  expected2.reverse();
...
fn version_format_l_mask1_version29() {
  ...
  let mut expected2: [bool; 18] = [
    false, true, true, true, false, true, false, false, true, true, false, false, true, true, true,
    true, true, true,
  ];
  expected2.reverse();
...
fn version_format_l_mask4_version36() {
  ...
  let mut expected2: [bool; 18] = [
    true, false, false, true, false, false, true, false, true, true, false, false, false, false,
...
fn version_format_m_mask1_version30() {
  ...
  let mut expected2: [bool; 18] = [
    false, true, true, true, true, false, true, true, false, true, false, true, true, true, false,
    true, false, true,
  ];
  expected2.reverse();
...
fn version_format_m_mask5_version13() {
  ...
  let mut expected2: [bool; 18] = [
    false, false, true, true, false, true, true, false, false, false, false, true, false, false,
...
fn version_format_q_mask3_version18() {
  ...
  let mut expected2: [bool; 18] = [
    false, true, false, false, true, false, true, false, true, false, false, false, false, true,
    false, true, true, true,
  ];
  expected2.reverse();
...
fn version_format_h_mask0_version35() {
  ...
  let mut expected2: [bool; 18] = [
    true, false, false, false, true, true, false, true, true, true, true, false, false, true, true,
    true, true, true,
  ];
  expected2.reverse();
